...
const Command kCommands[] = {
  { 4, "python3 ./g600.py 'G-shift + G9' &" },
  { 5, "python3 ./g600.py 'G-shift + G10' &" },
  { 6, "python3 ./g600.py 'G-shift + G11' &" },
  { 7, "python3 ./g600.py 'G-shift + G12' &" },
  { 8, "python3 ./g600.py 'G-shift + G13' &" },
  { 9, "python3 ./g600.py 'G-shift + G14' &" },
  { 10, "python3 ./g600.py 'G-shift + G15' &" },
  { 11, "python3 ./g600.py 'G-shift + G16' &" },
  { 12, "python3 ./g600.py 'G-shift + G17' &" },
  { 13, "python3 ./g600.py 'G-shift + G18' &" },
  { 14, "python3 ./g600.py 'G-shift + G19' &" },
  { 15, "python3 ./g600.py 'G-shift + G20' &" },
